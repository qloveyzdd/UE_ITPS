...
- **ast-outline**, commit `e17982960cdf0893236eeb9f7002f9098459d8bc`, Apache License 2.0. The local Tree-sitter adapter is the C# syntax frontend; all C++ source retrieval uses Clang. Its upstream notice is preserved in [`LICENSES/ast-outline-NOTICE.txt`](LICENSES/ast-outline-NOTICE.txt).
