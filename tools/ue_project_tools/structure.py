...
def classify_project_paths(project_root: Path, project_file: Path) -> dict[str, Any]:
    return result_document(
        "ue-itps.project-paths.v2",
        {
            ...
            "generated_or_local_state": [
                ...
                path_state(project_root, ".idea", "local-state", "JetBrains 本地状态"),
            ],
        },
        [],
        responsibility=(
            "Classify standard project-root paths as inputs, generated data, "
        ...
        boundaries=[
            ...
            "The tool does not inspect path contents or asset reachability.",
        ],
    )
