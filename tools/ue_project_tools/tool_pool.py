...
_TOOLS: tuple[dict[str, Any], ...] = (
    {
        ...
        "category": "project",
        "entrypoint": "tools/ue_find_projects.py",
        "inputs": ["search_root"],
    ...
    },
    {
        ...
        "category": "project",
        "entrypoint": "tools/ue_read_project_descriptor.py",
        "inputs": ["project"],
        "capabilities": [
            "project_descriptor",
            "module_declarations",
    ...
    },
    {
        ...
        "category": "project",
        "entrypoint": "tools/ue_resolve_engine.py",
        "inputs": ["project"],
    ...
    },
    {
        ...
        "category": "build",
        "entrypoint": "tools/ue_inspect_modules.py",
        "inputs": ["project"],
        "capabilities": [
    ...
    },
    {
        ...
        "category": "build",
        "entrypoint": "tools/ue_inspect_targets.py",
        "inputs": ["project"],
    ...
    },
    {
        ...
        "category": "source",
        "entrypoint": "tools/ue_list_project_cxx_sources.py",
        "inputs": ["project"],
    ...
    },
    {
        ...
        "category": "plugin",
        "entrypoint": "tools/ue_resolve_plugins.py",
        "inputs": ["project"],
    ...
    },
    {
        ...
        "category": "project",
        "entrypoint": "tools/ue_classify_project_paths.py",
        "inputs": ["project"],
    ...
    },
    {
        ...
        "category": "plugin",
        "entrypoint": "tools/ue_read_plugin_descriptor.py",
        "inputs": ["plugin"],
        "capabilities": [
            "plugin_descriptor",
            "module_reconciliation",
    ...
    },
    {
        ...
        "category": "build",
        "entrypoint": "tools/ue_inspect_module_rules.py",
        "inputs": ["rules"],
    ...
    },
    {
        ...
        "category": "build",
        "entrypoint": "tools/ue_inspect_target_rules.py",
        "inputs": ["target"],
    ...
    },
    {
        ...
        "category": "source",
        "entrypoint": "tools/ue_inspect_cs_function.py",
    ...
    },
    {
        ...
        "category": "module",
        "entrypoint": "tools/ue_inspect_module_entry.py",
        "inputs": ["rules"],
    ...
    },
    {
        ...
        "category": "source",
        "entrypoint": "tools/ue_list_cxx_includes.py",
        "inputs": ["source"],
    ...
    },
    {
        ...
        "category": "source",
        "entrypoint": "tools/ue_list_cxx_types.py",
        "inputs": ["source"],
    ...
    },
    {
        ...
        "category": "source",
        "entrypoint": "tools/ue_inspect_cxx_function.py",
        "inputs": ["source", "function"],
    ...
    },
    {
        "name": "ue_list_tools",
        "category": "pool",
        "entrypoint": "tools/ue_list_tools.py",
        "inputs": [],
    ...
    },
    {
        ...
        "category": "graph",
        "entrypoint": "tools/ue_analyze_cxx_dependencies.py",
        "inputs": ["project"],
    ...
    },
    {
        ...
        "category": "graph",
        "entrypoint": "tools/ue_query_cxx_hierarchy.py",
    ...
    },
    {
        ...
        "category": "graph",
        "entrypoint": "tools/ue_analyze_cxx_impact.py",
    ...
    },
    {
        ...
        "category": "graph",
        "entrypoint": "tools/ue_trace_cxx_function_flow.py",
        "inputs": ["source", "function"],
