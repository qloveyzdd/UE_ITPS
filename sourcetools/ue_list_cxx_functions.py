#!/usr/bin/env python3
"""List function definitions created by one or two selected C++ files."""
...
RESPONSIBILITY = "List all function definitions from selected files."


def main() -> int:
    parser = cli_parser(
        "列出一至两个显式选择的 C++ 文件所创建的函数定义。",
        "List function definitions created by one or two explicitly selected C++ files.",
